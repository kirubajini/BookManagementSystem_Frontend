              ...
              <CardContent>
                <Paper variant="outlined">
                  <form
                    ...
                    autoComplete="off"
                    style={{ width: "150%" }}
                    onSubmit={this.updateBookById}
                  >
                    {!this.state.successful && (
                      <Grid container spacing={1}>
                        <Grid item xs={11}>
                          <h5 style={{ fontSize: 30 }}>
                            <AddBoxIcon Style={{ fontSize: 10 }} />
                            Update Book
                          </h5>
                        </Grid>
                        <Grid item xs={12}>
                        ...
                        <Grid item xs={12}>
                          ...
                          <FormControl>
                            <TextField
                              ...
                              label="ISBN Number*"
                              variant="outlined"
                              helperText="Enter Book ISBAN Number"
                        ...
                        <Grid item xs={12}>
                          ...
                          <FormControl
                            size="small"
                            onChange={this.onChangeSelectLangue}
                          ...
                          <FormControl
                            size="small"
                            onChange={this.onChangeSelectGenre}
