...
class UserList extends Component {
  ...
  componentDidMount() {
    ...
    userService.getAllUsersInPage(0, 5).then((Response) => {
  ...
  handleChangePage = (event, newpage) => {
    ...
    if (!this.state.search) {
      userService.getAllUsersInPage(newpage, 5).then((Response) => {
        this.setState({
          users: Response.data.data,
          count: Response.data.Totalnoofelements,
        });
      ...
      userService.searchUser(this.state.search, newpage).then((Response) => {
        this.setState({
          users: Response.data.data,
