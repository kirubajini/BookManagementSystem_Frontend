...
class ViewBook extends Component {
  ...
  handleChangePage = (event, newPage) => {
    ...
    BookService.getAllBookInPage(newPage, this.state.rowsPerPage).then(
      (Response) => {
        this.setState({
  ...
  handleChangeRowsPerPage = (event) => {
    ...
    BookService.getAllBookInPage(this.state.page, event.target.value).then(
      (Response) => {
        this.setState({
          BookArr: Response.data.data,
          count: Response.data.TotalNoOfElements,
  ...
  reloadBookList = () => {
    BookService.getAllBookInPage(this.state.page, this.state.rowsPerPage).then(
      (Response) => {
        this.setState({
          BookArr: Response.data.data,
          count: Response.data.TotalNoOfElements,
  ...
  searchedBook = (e) => {
    ...
    BookService.searchedBook(e.target.value, 0).then((Response) => {
      this.setState({
        BookArr: Response.data.data,
      });
    });
                  ...
                  {this.state.BookArr.map((row) => (
                    <TableRow key={row.id}>
                      <TableCell>
                        <IconButton>
                          <DeleteIcon
                            onClick={() => this.deleteBook(row.id)}
                            color="default"
                            align="left"
                            inputProps={{
                              "aria-label": "DeleteIcon with default color",
                            }}
                          />
                        </IconButton>
